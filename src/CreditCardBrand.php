...
{    
    ...
    public function pattern(): ?string
    {
        return match ($this) {
            ...
            self::MASTERCARD => "/^5[1-5][0-9]{14}$|^2(?:2(?:2[1-9]|[3-9][0-9])|[3-6][0-9][0-9]|7(?:[01][0-9]|20))[0-9]{12}$/",
            // 16 dígitos 4242 4242 4242 4242
            self::VISA => "/^4[0-9]{12}(?:[0-9]{3})?$/",
            // 16 dígitos: 6011 1111 1111 1117
            self::DISCOVER => "/^65[4-9][0-9]{13}|64[4-9][0-9]{13}|6011[0-9]{12}|(622(?:12[6-9]|1[3-9][0-9]|[2-8][0-9][0-9]|9[01][0-9]|92[0-5])[0-9]{10})$/",
