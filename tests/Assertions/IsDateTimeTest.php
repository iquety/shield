...
class IsDateTimeTest extends TestCase
{
    ...
    public function correctValueProvider(): array
    {
        ...
        $list['US format'] = ['12/31/2024 11:59:59 PM'];
    ...
    public function incorrectValueProvider(): array
    {
        ...
        $list['US format month'] = ['13/31/2024 11:59:59 PM'];
        $list['US format day'] = ['12/32/2024 11:59:59 PM'];
        $list['US format hour'] = ['12/31/2024 26:59:59 PM'];
        $list['US format minute'] = ['12/31/2024 11:62:59 PM'];
        $list['US format second'] = ['12/31/2024 11:59:62 PM'];
